...
const SmartDoorlocks = () => {
  ...
  const products = {
    'ultralock': [
      {
        name: 'Ultralock U-Bolt Pro',
        price: 199.99,
        discount: 20.0,
        image: '/images/doorlocks/ultralock-pro.jpg',
        category: 'Smart Doorlocks'
      },
      {
        name: 'Ultralock Touch',
        price: 249.99,
        discount: 15.0,
        image: '/images/doorlocks/ultralock-touch.jpg',
        category: 'Smart Doorlocks'
      }
    ],
    'august': [
      {
        ...
        price: 229.99,
        discount: 25.0,
        image: '/images/doorlocks/august-wifi.jpg',
        category: 'Smart Doorlocks'
      },
      {
        name: 'August Pro Smart Lock',
        price: 279.99,
        discount: 30.0,
        image: '/images/doorlocks/august-pro.jpg',
        category: 'Smart Doorlocks'
      }
    ],
    'bosma': [
      {
        ...
        price: 159.99,
        discount: 20.0,
        image: '/images/doorlocks/bosma-aegis.jpg',
        category: 'Smart Doorlocks'
      },
      {
        name: 'Bosma X1',
        price: 189.99,
        discount: 15.0,
        image: '/images/doorlocks/bosma-x1.jpg',
        category: 'Smart Doorlocks'
      }
    ]
  };
      ...
      <div className="bg-gray-900/50 rounded-xl shadow-2xl overflow-hidden backdrop-blur-sm border border-purple-500/20">
        ...
        <div className="p-6">
          <h2 className="text-3xl font-bold font-montserrat tracking-wide bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-300 to-purple-400">
            Smart Doorlocks {brand && `- ${brand.charAt(0).toUpperCase() + brand.slice(1)}`}
          </h2>
        </div>
      </div>
