...
const SmartDoorbells = () => {
  ...
  const products = {
    'arlo': [
      {
        name: 'Arlo Essential Wire-Free',
        price: 199.99,
        discount: 20.0,
        image: '/images/doorbells/arlo-essential.jpg',
      ...
      },
      {
        ...
        price: 249.99,
        discount: 15.0,
        image: '/images/doorbells/arlo-video.jpg',
        category: 'Smart Doorbells'
      }
    ],
    'eufy': [
      {
        name: 'Eufy Security WiFi',
        price: 169.99,
        discount: 25.0,
        image: '/images/doorbells/eufy-wifi.jpg',
        category: 'Smart Doorbells'
      },
      {
        name: 'Eufy Dual Camera',
        price: 199.99,
        discount: 30.0,
        image: '/images/doorbells/eufy-dual.jpg',
        category: 'Smart Doorbells'
      }
    ],
    'nest': [
      {
        ...
        price: 189.99,
        discount: 20.0,
        image: '/images/doorbells/nest-mini.jpg',
        category: 'Smart Doorbells'
      },
      {
        name: 'Nest Pro',
        price: 229.99,
        discount: 40.0,
        image: '/images/doorbells/nest-pro.jpg',
        category: 'Smart Doorbells'
      }
    ]
  };
      ...
      <div className="bg-gray-900/50 rounded-xl shadow-2xl overflow-hidden backdrop-blur-sm border border-purple-500/20">
        ...
        <div className="p-6">
          <h2 className="text-3xl font-bold font-montserrat tracking-wide bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-300 to-purple-400">
            Smart Doorbells {brand && `- ${brand.charAt(0).toUpperCase() + brand.slice(1)}`}
          </h2>
        </div>
      </div>
